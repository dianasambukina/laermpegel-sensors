...
public class SensorImpl extends java.rmi.server.UnicastRemoteObject implements Sensor {
    ...
    // Latitude
    private Double y;
    private Double rangeMinX = 52.3822;
    private Double rangeMaxX = 52.6357;
    private Double rangeMinY = 13.1202;
    private Double rangeMaxY = 13.6316;
    ...
    void setData() {
        ...
        this.setX((rangeMinX + (rangeMaxX - rangeMinX) * r.nextDouble()));
        this.setY((rangeMinY + (rangeMaxY - rangeMinY) * r.nextDouble()));
    }
